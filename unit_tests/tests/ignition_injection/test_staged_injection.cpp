...
namespace {
    ...
    constexpr BattLagCorrCurve generateConstantBattLagCorrCurve(const float value) {
        BattLagCorrCurve testBattLagCorrCurve;
        testBattLagCorrCurve.fill(value);
        return testBattLagCorrCurve;
    }

    constexpr BattLagCorrCurve TEST_PRIMARY_INJECTOR_BATT_LAG_CORR_CURVE = generateConstantBattLagCorrCurve(
        TEST_PRIMARY_INJECTOR_DEAD_TIME
    );
    constexpr BattLagCorrCurve TEST_SECONDARY_INJECTOR_BATT_LAG_CORR_CURVE = generateConstantBattLagCorrCurve(
